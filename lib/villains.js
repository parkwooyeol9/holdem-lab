...
// Hero sits at the bottom. Seat ids increase clockwise on screen (left from hero).
// Standard 6-max overlay: CO on the left, SB on the right. Next hand the D
// chip moves left (seat+1) and you go BTN → SB → BB → UTG → HJ → CO.
export const CLOCKWISE_FROM_BTN = ["BTN", "CO", "HJ", "UTG", "BB", "SB"];
