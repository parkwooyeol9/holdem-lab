...
// Action also goes left: BTN, then SB, BB, UTG, HJ, CO. Next hand the D chip
// moves left onto the old SB, and you go BTN → CO → HJ → UTG → BB → SB.
export const CLOCKWISE_FROM_BTN = ["BTN", "SB", "BB", "UTG", "HJ", "CO"];
export const FLOP_ORDER = ["SB", "BB", "UTG", "HJ", "CO", "BTN"];
